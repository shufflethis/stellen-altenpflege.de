      ...
      <footer className="bg-white border-t border-rose-100 py-20 mt-20">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="text-rose-600/60 hover:text-rose-600 transition-colors">Impressum</a>
            <a href="#" className="text-rose-600/60 hover:text-rose-600 transition-colors">Datenschutz</a>
