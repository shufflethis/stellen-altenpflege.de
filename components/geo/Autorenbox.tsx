  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von stellen-altenpflege.de. Mit jahrelanger Erfahrung im
        Bereich Altenpflege und Personalwesen hat er dieses spezialisierte Jobportal
        ins Leben gerufen, um Arbeitgeber und qualifizierte Fachkraefte zusammenzubringen.
      </p>
      <div className="autorenbox-links">
        <a href="https://stellen-altenpflege.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
