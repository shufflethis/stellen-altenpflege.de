            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist stellen-altenpflege.de zu einer führenden Anlaufstelle für Altenpflege-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Altenpflege-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Altenpflege-Bereich' },
